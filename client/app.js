	...
	var jte={
		...
		initialize:function(){
			var obj=new JTEObject(400,180,390,40,[0,0,0],0,1,'{"text":"Skins:","size":24,"align":"center","font":"Consolas"}',true,'Start','[""]',false,-1,'Obj398');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(0,-3600,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj342');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(0,-3890,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj351');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(40,-3930,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj352');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(80,-3970,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj353');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(80,-4020,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj354');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\tif(jt.pConnected(0)){this.attr.text=\"A Jump\"}else{this.attr.text=\"Z Jump\"}","  ","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(730,500,70,60,[0,0,0],0,1,'{"text":"Jump then Fly !","size":16,"font":"Consolas","align":"center"}',true,'Fuelgame','[""]',false,-1,'Obj430');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1800,0,80,40,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj43');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1960,100,40,40,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj44');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1880,40,40,40,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj418');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1340,-2580,40,40,[127,127,127],0,1,'{"img":"bumper"}',true,'Fuelgame','["Bumper"]',false,-1,'Obj434');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1380,-2380,40,40,[127,127,127],0,1,'{"img":"bumper"}',true,'Fuelgame','["Bumper"]',false,-1,'Obj360');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1460,-2380,40,40,[127,127,127],0,1,'{"img":"bumper"}',true,'Fuelgame','["Bumper"]',false,-1,'Obj433');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(260,-3430,40,40,[127,127,127],0,1,'{"img":"bumper"}',true,'Fuelgame','["Bumper"]',false,-1,'Obj436');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(600,-3350,40,40,[127,127,127],0,1,'{"img":"bumper"}',true,'Fuelgame','["Bumper"]',false,-1,'Obj427');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1460,-2940,20,20,[0,255,0],0,1,'undefined',true,'Fuelgame','["Wall","Refill"]',false,-1,'Obj421');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1780,-2560,20,80,[0,255,0],0,1,'undefined',true,'Fuelgame','["Wall","Refill"]',false,-1,'Obj241');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(0,-420,20,140,[0,255,0],0,1,'undefined',true,'Fuelgame','["Wall","Refill"]',false,-1,'Obj62');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1780,-2480,20,680,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj242');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1560,-4220,10,10,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj381');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1520,-4260,10,10,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj384');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1520,-4180,10,10,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj379');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1530,-3480,10,10,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj426');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(220,-3470,20,20,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj423');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(90,-4030,90,520,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj341');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1180,-1360,40,20,[0,255,0],0,1,'undefined',true,'Fuelgame','["Wall","Refill"]',false,-1,'Obj93');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(800,-2380,20,1080,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj100');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(800,-1300,20,20,[0,255,0],0,1,'undefined',true,'Fuelgame','["Wall","Refill"]',false,-1,'Obj105');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1180,-1220,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj431');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1180,-1270,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj432');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1920,-1790,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj428');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1880,-1790,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj429');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1780,-1720,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj419');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1980,-3320,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj435');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1860,-3720,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj424');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1480,-4260,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj425');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1180,-1170,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj420');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1030,-1170,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj112');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1130,-1170,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj113');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(980,-1170,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj180');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1080,-1170,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj114');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(300,-3430,60,1290,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj195');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1100,-2940,20,360,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj213');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1480,-2940,20,20,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj233');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1220,-1360,20,20,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj422');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(40,-3640,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj343');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(80,-3680,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj346');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(40,-3720,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj347');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(80,-3760,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj348');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(40,-3800,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj349');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(0,-3840,10,10,[0,255,0],0,1,'undefined',true,'Fuelgame','["Fuel"]',false,-1,'Obj350');/*You can put functions here*/
...
obj.addFuel=function(x,y,dir){
  var client=jt.getObject("Client");
  client.clientObj.fuels.push({alpha:1,x:x,y:y,r:0,timer:this.fuelMax,vX:dir/2,vY:-1,w:10,h:10,c:[0,255,0]})
}
...
obj.setup=function(){	/*Setup runs once when the game starts*/
  ...
  for(var i=0;i<client.clientObj.fuels.length;i++){
    ...
    client.clientObj.fuels[i].vY+=0.04;
    ...
    jt.rect(fuel);
    if(jt.cRect(p,fuel) && fuel.timer<=this.fuelMax-this.sendFuelMax){
    ...
    for(var j=0;j<walls.length;j++){
      ...
      if(jt.cRect(fuel,wall) && wall.tags.indexOf("Timer")==-1){
        fuel.y-=fuel.vY;
        if(jt.cRect(fuel,wall)){
          //only horizontal
          client.clientObj.fuels[i].vX=-client.clientObj.fuels[i].vX
          if(wall.x+wall.w/2>fuel.x+fuel.w/2){
           	 client.clientObj.fuels[i].x=wall.x-fuel.w;
          }else{
            client.clientObj.fuels[i].x=wall.x+wall.w;
          }
        }
        fuel.y+=fuel.vY;
        if(jt.cRect(fuel,wall)){
          //both
          client.clientObj.fuels[i].vY=-client.clientObj.fuels[i].vY*0.5;
          
          if(wall.y+wall.h/2>fuel.y+fuel.h/2){
           	 client.clientObj.fuels[i].y=wall.y-fuel.h;
          }else{
            client.clientObj.fuels[i].y=wall.y+wall.h;
          }
          
          if(jt.abs(client.clientObj.fuels[i].vY)<=0.1){
            client.clientObj.fuels.splice(i,1);
            i--;
            break; 
          }
  ...
  if(this.sendFuel>0){
   ...
   var paddingX=5;
   var paddingY=10;  
  var obj={x:p.x-paddingX,y:p.y-paddingY,w:p.w+paddingX*2,h:p.h+paddingY*2};
  ...
  jt.alpha(1);
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/","","obj.fuels=[];","obj.timerMax=120;","obj.rotationSpeed=3;","obj.fuelRatio=0.25;","","obj.gotFuelMax=20;","obj.gotFuel=0;","","obj.sendFuelMax=30;","obj.sendFuel=0;","","obj.fuelMax=420;","","obj.addFuel=function(x,y,dir){","  var client=jt.getObject(\"Client\");","  client.clientObj.fuels.push({alpha:1,x:x,y:y,r:0,timer:this.fuelMax,vX:dir/2,vY:-1,w:10,h:10,c:[0,255,0]})","}",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\tthis.alpha=0;","  this.fuels=jte.getObjects([\"Fuel\"])","  for(var i=0;i<this.fuels.length;i++){","   \t\tthis.fuels[i].timer=0;     ","  }","  "];obj.JTEupdate=["\t/*Update runs at the fps specified*/","  var p=jte.getObject(\"Player2\");","  jt.alpha(1);","  ","\tfor(var i=0;i<this.fuels.length;i++){","    if(this.fuels[i].timer>0){","      this.fuels[i].timer--;","      if(this.fuels[i].timer<=0){","       \tthis.fuels[i].tags=[\"Fuel\"]; ","       \tthis.fuels[i].alpha=1;         ","      }","    }else{","       this.fuels[i].r+=this.rotationSpeed;","      \tvar p=jte.getObject(\"Player2\");","      \tif(jt.cRect(p,this.fuels[i])){","          ","         \tthis.fuels[i].timer=this.timerMax;","          this.fuels[i].alpha=0;","          p.fuel+=p.fuelMax*this.fuelRatio;","          if(p.fuel>p.fuelMax){p.fuel=p.fuelMax}","          jt.stopPlay(\"refill\")","        }","    }","  }","  ","  var client=jt.getObject(\"Client\");","  var fuels=[];","  var serverObjs=client.serverObjs;","  var keys=Object.keys(serverObjs);","  var len=Object.keys(serverObjs).length;","  var index=1;","  ","  var walls=jt.getObjects([\"Wall\"]);","","  jt.fontSize(14);","  for(var i=0;i<client.clientObj.fuels.length;i++){","    var fuel=client.clientObj.fuels[i];","    client.clientObj.fuels[i].timer--;","    client.clientObj.fuels[i].vY+=0.04;","    client.clientObj.fuels[i].x+=fuel.vX;    ","    client.clientObj.fuels[i].y+=fuel.vY;","    ","    client.clientObj.fuels[i].r+=this.rotationSpeed;","    fuels.push(client.clientObj.fuels[i]);","    jt.rect(fuel);","    if(jt.cRect(p,fuel) && fuel.timer<=this.fuelMax-this.sendFuelMax){","      client.clientObj.fuels.splice(i,1);","      i--;","      p.fuel+=p.fuelMax*this.fuelRatio;","      if(p.fuel>p.fuelMax){p.fuel=p.fuelMax}","      jt.stopPlay(\"refill\")","     \tcontinue; ","      ","    }","    if(client.clientObj.fuels[i].timer<=0){","      client.clientObj.fuels.splice(i,1);","       i--;","     \tcontinue; ","    }","    ","    for(var j=0;j<walls.length;j++){","      var wall=walls[j];","      ","      if(jt.cRect(fuel,wall) && wall.tags.indexOf(\"Timer\")==-1){","        fuel.y-=fuel.vY;","        if(jt.cRect(fuel,wall)){","          //only horizontal","          client.clientObj.fuels[i].vX=-client.clientObj.fuels[i].vX","          if(wall.x+wall.w/2>fuel.x+fuel.w/2){","           \t client.clientObj.fuels[i].x=wall.x-fuel.w;","          }else{","            client.clientObj.fuels[i].x=wall.x+wall.w;","          }","        }","        fuel.y+=fuel.vY;","        if(jt.cRect(fuel,wall)){","          //both","          client.clientObj.fuels[i].vY=-client.clientObj.fuels[i].vY*0.5;","          ","          if(wall.y+wall.h/2>fuel.y+fuel.h/2){","           \t client.clientObj.fuels[i].y=wall.y-fuel.h;","          }else{","            client.clientObj.fuels[i].y=wall.y+wall.h;","          }","          ","          if(jt.abs(client.clientObj.fuels[i].vY)<=0.1){","            client.clientObj.fuels.splice(i,1);","            i--;","            break; ","          }","        }","        ","        ","        /*","        client.clientObj.fuels.splice(i,1);","        i--;","       \tbreak; ","        */","        break;","      }","    }","    ","  }","  ","  if(this.gotFuel>0){","  \tthis.gotFuel--;","  }","  ","  if(this.sendFuel>0){","  \tthis.sendFuel--;","  }","  ","   var paddingX=5;","   var paddingY=10;  ","  var obj={x:p.x-paddingX,y:p.y-paddingY,w:p.w+paddingX*2,h:p.h+paddingY*2};","  ","  for (var i = 0; i < len; i++) {","    var other = serverObjs[keys[i]];","    var fuels=other.fuels;","   ","    ","    for(var j=0;j<fuels.length;j++){","      jt.rect(fuels[j]);","      if(this.gotFuel<=0){","","        if(jt.cRect(obj,fuels[j])){","          this.gotFuel=this.gotFuelMax ","          //emit","          //this.socket.on(\"accept\",function(senderId){","","","          //var obj={x:p.x-padding,y:p.y-padding,w:p.w+padding/2,h:p.h+padding/2};","          jt.getObject(\"Client\").socket.emit(\"gotFuel\",keys[i],obj);","","          p.fuel+=p.fuelMax*this.fuelRatio;","          if(p.fuel>p.fuelMax){p.fuel=p.fuelMax}","          jt.stopPlay(\"refill\")","        }","      }","    }","  }","  ","  for(var i=0;i<this.fuels.length;i++){","    if(this.fuels[i].timer>0){","      this.fuels[i].timer--;","      if(this.fuels[i].timer<=0){","       \tthis.fuels[i].tags=[\"Fuel\"]; ","       \tthis.fuels[i].alpha=1;         ","      }","    }else{","       this.fuels[i].r+=this.rotationSpeed;","      \tvar p=jte.getObject(\"Player2\");","      \tif(jt.cRect(p,this.fuels[i])){","          jt.stopPlay(\"refill\")","         \tthis.fuels[i].timer=this.timerMax;","          this.fuels[i].alpha=0;","          p.fuel+=p.fuelMax*this.fuelRatio;","          if(p.fuel>p.fuelMax){p.fuel=p.fuelMax}","        }","    }","  }","  jt.alpha(1);","  ","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(60,10,110,20,[0,0,0],0,1,'undefined',false,'Fuelgame','[""]',false,-1,'Obj16');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
  ...
  jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t//jt.camActive(false);","  ","  "];obj.JTEupdate=["\t/*Update runs at the fps specified*/"," \tthis.attr.text=\"Current username: \"+jt.getObject(\"Client\").clientObj.name;","  jte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(520,220,70,20,[0,0,0],0,1,'{"text":"John","size":16,"align":"center","font":"Consolas"}',true,'Start','[""]',false,-1,'Obj403');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
  ...
  jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t//jt.camActive(false);","  ","  "];obj.JTEupdate=["\t/*Update runs at the fps specified*/","  ","  jte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(600,220,70,20,[0,0,0],0,1,'{"text":"Guy","size":16,"align":"center","font":"Consolas"}',true,'Start','[""]',false,-1,'Obj410');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
  ...
  jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t//jt.camActive(false);","  ","  "];obj.JTEupdate=["\t/*Update runs at the fps specified*/","  ","  jte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(440,310,70,20,[0,0,0],0,1,'{"text":"Delivery","size":16,"align":"center","font":"Consolas"}',true,'Start','[""]',false,-1,'Obj404');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
  ...
  jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t//jt.camActive(false);","  ","  "];obj.JTEupdate=["\t/*Update runs at the fps specified*/","  ","  jte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(680,220,70,20,[0,0,0],0,1,'{"text":"Girl","size":16,"align":"center","font":"Consolas"}',true,'Start','[""]',false,-1,'Obj411');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
  ...
  jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t//jt.camActive(false);","  ","  "];obj.JTEupdate=["\t/*Update runs at the fps specified*/","  ","  jte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(440,220,70,20,[0,0,0],0,1,'{"text":"Indiana","size":16,"align":"center","font":"Consolas"}',true,'Start','[""]',false,-1,'Obj405');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
  ...
  jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t//jt.camActive(false);","  ","  "];obj.JTEupdate=["\t/*Update runs at the fps specified*/","  ","  jte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(600,310,70,20,[0,0,0],0,1,'{"text":"Count","size":16,"align":"center","font":"Consolas"}',true,'Start','[""]',false,-1,'Obj412');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
  ...
  jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t//jt.camActive(false);","  ","  "];obj.JTEupdate=["\t/*Update runs at the fps specified*/","  ","  jte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(520,310,70,20,[0,0,0],0,1,'{"text":"Metrony","size":16,"align":"center","font":"Consolas"}',true,'Start','[""]',false,-1,'Obj406');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
  ...
  jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t//jt.camActive(false);","  ","  "];obj.JTEupdate=["\t/*Update runs at the fps specified*/","  ","  jte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(680,310,70,20,[0,0,0],0,1,'{"text":"Miner","size":16,"align":"center","font":"Consolas"}',true,'Start','[""]',false,-1,'Obj413');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
  ...
  jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t//jt.camActive(false);","  ","  "];obj.JTEupdate=["\t/*Update runs at the fps specified*/"," \t//this.attr.text=\"Current username: \"+jt.getObject(\"Client\").playerName;","  jte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(40,270,350,60,[127,127,127],0,1,'undefined',true,'Start','[""]',false,-1,'BtnChange');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
    ...
    if(jt.getObject("Client").clientObj.name.trim()!=""){
      if(jt.mPress(this)){
        ...
        jt.resize(800,600,true)
  			jt.smoothing(false);
        
        var player=jt.getObject("Player2");
        
        jt.cam().w=player.camW;
  			jt.cam().h=player.camH;
      }
    }else{
	...
	jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\tif(jt.mIn(this)){","   \tjte.getObject(\"BtnConnect\").c=[200,200,200]","  }else{","    jte.getObject(\"BtnConnect\").c=[127,127,127]","  }","\tif(jt.mPress(this) || jt.tPress(this)){","    if(jt.getObject(\"Client\").clientObj.name.trim()!=\"\"){","      if(jt.mPress(this)){","        jte.setView(\"Fuelgame\"); ","        ","        jt.resize(800,600,true)","  \t\t\tjt.smoothing(false);","        ","        var player=jt.getObject(\"Player2\");","        ","        jt.cam().w=player.camW;","  \t\t\tjt.cam().h=player.camH;","      }","    }else{","     jt.getObject(\"Error\").attr.text=\"Username can't be empty !\"; ","    }","  }","  ","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(40,290,350,30,[0,0,0],0,1,'{"text":"Change username","size":24,"align":"center","font":"Consolas"}',true,'Start','[""]',false,-1,'Obj1791');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jt.drawObject(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjt.drawObject(this);"];jte.objects.push(obj);var obj=new JTEObject(460,330,30,60,[127,127,127],0,1,'{"img":"deliveryIdle","sX":0,"sY":0,"sW":10,"sH":20}',true,'Start','["Skin","delivery"]',false,-1,'Obj399');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jt.drawObject(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjt.drawObject(this);"];jte.objects.push(obj);var obj=new JTEObject(700,240,30,60,[127,127,127],0,1,'{"img":"girlIdle","sX":0,"sY":0,"sW":10,"sH":20}',true,'Start','["Skin","girl"]',false,-1,'Obj414');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jt.drawObject(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjt.drawObject(this);"];jte.objects.push(obj);var obj=new JTEObject(540,240,30,60,[127,127,127],0,1,'{"img":"johnIdle","sX":0,"sY":0,"sW":10,"sH":20}',true,'Start','["Skin","john"]',false,-1,'Obj400');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jt.drawObject(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjt.drawObject(this);"];jte.objects.push(obj);var obj=new JTEObject(620,240,30,60,[127,127,127],0,1,'{"img":"guyIdle","sX":0,"sY":0,"sW":10,"sH":20}',true,'Start','["Skin","guy"]',false,-1,'Obj415');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jt.drawObject(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjt.drawObject(this);"];jte.objects.push(obj);var obj=new JTEObject(460,240,30,60,[127,127,127],0,1,'{"img":"indianaIdle","sX":0,"sY":0,"sW":10,"sH":20}',true,'Start','["Skin","indiana"]',false,-1,'Obj401');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jt.drawObject(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjt.drawObject(this);"];jte.objects.push(obj);var obj=new JTEObject(620,330,30,60,[127,127,127],0,1,'{"img":"countIdle","sX":0,"sY":0,"sW":10,"sH":20}',true,'Start','["Skin","count"]',false,-1,'Obj416');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jt.drawObject(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjt.drawObject(this);"];jte.objects.push(obj);var obj=new JTEObject(540,330,30,60,[127,127,127],0,1,'{"img":"metronyIdle","sX":0,"sY":0,"sW":10,"sH":20}',true,'Start','["Skin","metrony"]',false,-1,'Obj402');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jt.drawObject(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjt.drawObject(this);"];jte.objects.push(obj);var obj=new JTEObject(700,330,30,60,[127,127,127],0,1,'{"img":"minerIdle","sX":0,"sY":0,"sW":10,"sH":20}',true,'Start','["Skin","miner"]',false,-1,'Obj417');/*Attributes and methods go here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	loadAssets([{type:"image",
			...
			name:"countIdle"}]);loadAssets([{type:"image",
			path:jte.path+"assets/countWalk.png",
			name:"countWalk"}]);loadAssets([{type:"image",
			path:jte.path+"assets/defaultAir.png",
			name:"defaultAir"}]);loadAssets([{type:"image",
			path:jte.path+"assets/defaultIdle.png",
			name:"defaultIdle"}]);loadAssets([{type:"image",
			path:jte.path+"assets/defaultWalk.png",
			name:"defaultWalk"}]);loadAssets([{type:"image",
			path:jte.path+"assets/deliveryAir.png",
			name:"deliveryAir"}]);loadAssets([{type:"image",
			path:jte.path+"assets/deliveryIdle.png",
			name:"deliveryIdle"}]);loadAssets([{type:"image",
			path:jte.path+"assets/deliveryWalk.png",
			name:"deliveryWalk"}]);loadAssets([{type:"image",
			...
			path:jte.path+"assets/johnAir.png",
			name:"johnAir"}]);loadAssets([{type:"image",
			path:jte.path+"assets/johnIdle.png",
			name:"johnIdle"}]);loadAssets([{type:"image",
			path:jte.path+"assets/johnWalk.png",
			name:"johnWalk"}]);loadAssets([{type:"image",
			path:jte.path+"assets/metronyAir.png",
			name:"metronyAir"}]);loadAssets([{type:"image",
			path:jte.path+"assets/metronyIdle.png",
			name:"metronyIdle"}]);loadAssets([{type:"image",
			path:jte.path+"assets/metronyWalk.png",
			name:"metronyWalk"}]);loadAssets([{type:"image",
