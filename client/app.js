...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*You can put functions here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(1100,-2960,20,380,[127,127,127],0,1,'undefined',true,'Fuelgame','["Wall"]',false,-1,'Obj213');/*You can put functions here*/
...
obj.setup=function(){	/*Setup runs once when the game starts*/
  ...
  for(var i=0;i<client.clientObj.fuels.length;i++){
    ...
    jt.rect(fuel);
    if(jt.cRect(p,fuel) && fuel.timer<=360-this.sendFuelMax){
    ...
    for(var j=0;j<walls.length;j++){
      ...
      if(jt.cRect(fuel,wall) && wall.tags.indexOf("Timer")==-1){
        ...
        if(jt.cRect(fuel,wall)){
          ...
          if(jt.abs(client.clientObj.fuels[i].vY)<=0.2){
            client.clientObj.fuels.splice(i,1);
            i--;
            break; 
          }
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(720,0,80,30,[0,0,0],0,1,'{"text":"v0.97","size":23,"font":"Consolas","align":"right"}',true,'Start','[""]',false,-1,'Obj16');/*Attributes and methods go here*/
