...
obj.clientObj={name:"",sprite:"",x:0,y:0,dir:1,fuel:0,time:0,state:"",done:false,playing:false};
obj.serverObjs={};
...
obj.setup=function(){	/*Setup runs once when the game starts*/
	...
	jte.draw(this);
};obj.JTEcode=["/*Attributes and methods go here*/",""];obj.JTEsetup=["\t/*Setup runs once when the game starts*/","\t"];obj.JTEupdate=["\t/*Update runs at the fps specified*/","\t","\tjte.draw(this);"];jte.objects.push(obj);var obj=new JTEObject(720,0,80,30,[0,0,0],0,1,'{"text":"v0.75","size":23,"font":"Consolas","align":"right"}',true,'Start','[""]',false,-1,'Obj16');/*Attributes and methods go here*/
